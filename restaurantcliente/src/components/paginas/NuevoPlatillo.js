...
import { useFormik } from "formik"; //npm i formik (para forms)
import * as Yup from "yup"; //npm i yup (para validaciones de forms)
import { FirebaseContext } from "../../firebase";
import { useNavigate } from "react-router-dom";
import FileUploader from "react-firebase-file-uploader";
//w-full : toma todo el weight disponible
//py-2 : toma un padding vertical (Arriba y abajo) de 2
//px-3: toma un padding horizontal (izquierda y derecha) de 3
const NuevoPlatillo = () => {
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <select
                ...
                onBlur={formik.handleBlur}
              >
                <option value="desayuno">-- Seleccione --</option>
